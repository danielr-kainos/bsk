...
SELECT setval(pg_get_serial_sequence('Addresses', 'id'), coalesce(max(id),1), false) FROM Addresses;
...
SELECT setval(pg_get_serial_sequence('AddressNotes', 'id'), coalesce(max(id),1), false) FROM AddressNotes;
...
SELECT setval(pg_get_serial_sequence('Suspects', 'id'), coalesce(max(id),1), false) FROM Suspects;
...
SELECT setval(pg_get_serial_sequence('SuspectNotes', 'id'), coalesce(max(id),1), false) FROM SuspectNotes;
...
SELECT setval(pg_get_serial_sequence('Offences', 'id'), coalesce(max(id),1), false) FROM Offences;
...
SELECT setval(pg_get_serial_sequence('Participations', 'id'), coalesce(max(id),1), false) FROM Participations;
